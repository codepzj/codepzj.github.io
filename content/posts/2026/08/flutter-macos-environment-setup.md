---
title: "macOS 搭建 Flutter Android 与 iOS 开发环境"
description: "记录在 Apple Silicon Mac 上搭建 Flutter 开发环境的完整过程，包括 Android Studio、Android SDK、模拟器、Xcode、CocoaPods、代理配置以及 flutter doctor 常见问题。"
date: '2026-08-02'
updated: '2026-08-02'
categories:
- 移动开发
...
| 目标平台 | 必需工具 | 主要作用 |
|---|---|---|
| Android | Android Studio、Android SDK | 编译、打包、模拟器和真机调试 |
| iOS/macOS | Xcode、CocoaPods | iOS SDK、模拟器、签名和原生插件依赖 |
| Web | Chrome | Web 调试和运行 |

::alert{type="info" title="先确定目标平台"}
...
::alert{type="warning" title="Command Line Tools 不等于完整 Xcode"}
...
| 学习 Flutter/iOS | 可以 |
| 使用 iOS 模拟器 | 可以 |
| 在自己的 iPhone 上真机调试 | 可以，但签名有效期和数量有限制 |
| 发布到 App Store | 不可以 |
| 使用 TestFlight 分发 | 不可以 |
| 正式证书和长期分发 | 不可以 |
...
::alert{type="error" title="优先检查系统代理"}
...
- Flutter SDK 手动安装：https://docs.flutter.dev/install/manual
...
- Flutter Android Studio 配置：https://docs.flutter.dev/tools/android-studio
- Flutter VS Code 配置：https://docs.flutter.dev/tools/vs-code
