---
title: "Go 使用 MinIO SDK 上传文件"
description: MinIO 是一款开源的分布式对象存储服务，兼容 S3 协议，通过 Go SDK 可以轻松实现文件上传，只需初始化客户端并调用 FPutObject
  方法即可完成文件存储，支持自定义 Content-Type 和私有化部署，是替代商业 OSS 的高性价比方案。
date: '2025-07-31'
updated: '2025-07-31'
categories:
- Go语言
