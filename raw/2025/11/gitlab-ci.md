# GitLab Runner 使用与 CICD 全面指南

> Gitlab使用教程以及CI/CD的配置，触发工作流，减少手动部署的成本
...
<tbody>
  <tr>
    <td>
      Runner 有标签 build，Job 标签写 build
    </td>
  ...
  <tr>
    <td>
      Runner 有标签 build，Job 没写标签但勾了 Run untagged jobs
    </td>
  ...
  <tr>
    <td>
      Runner 有标签 build，Job 没写标签且未勾选 Run untagged jobs
    </td>
